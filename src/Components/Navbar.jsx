      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <button className="px-6 py-2.5 bg-indigo-500 text-white rounded-full font-semibold shadow-md hover:bg-indigo-600 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                Logout
              </button>
            ) : (
              <>
